...
|---|---|---|
| `ts/` | @voxgig-sdk/discard-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/discard-sdk \
      --repository voxgig-sdk/discard-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/discard-sdk` shows it, and
`npm trust revoke @voxgig-sdk/discard-sdk --id=<id>` removes it.
