...
class DiscardCacheFeature extends DiscardBaseFeature
{
    ...
    private function _through(DiscardContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
