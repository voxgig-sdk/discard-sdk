...
class DiscardTimeoutFeature extends DiscardBaseFeature
{
    ...
    private function _with_timeout(DiscardContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(DiscardContext $_ctx, float $ms): void
    {
        $client = $this->client;
