...
class DiscardProxyFeature extends DiscardBaseFeature
{
    ...
    public function init(DiscardContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (DiscardContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
