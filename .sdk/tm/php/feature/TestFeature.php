...
// Discard SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class DiscardTestFeature extends DiscardBaseFeature
{
    ...
    public function init(DiscardContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (DiscardContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (DiscardContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(DiscardContext $ctx, $op, $args): array
    {
