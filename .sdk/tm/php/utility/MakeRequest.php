...
// Discard SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class DiscardMakeRequest
{
    public static function call(DiscardContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new DiscardResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new DiscardResponse($fetched);
        } else {
