...
// Discard SDK utility: fetcher

class DiscardFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; DiscardSDK/1.0)';
    ...
    public static function call(DiscardContext $ctx, string $fullurl, array $fetchdef): array
    {
