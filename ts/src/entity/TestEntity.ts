...
class TestEntity extends DiscardEntityBase<Test> {
  ...
  async load(this: any, reqmatch?: TestLoadMatch, ctrl?: Control): Promise<TestEntity> {
  ...
  async create(this: any, reqdata?: TestCreateData, ctrl?: Control): Promise<TestEntity> {
  ...
  async update(this: any, reqdata?: TestUpdateData, ctrl?: Control): Promise<TestEntity> {
  ...
  async remove(
    this: any, reqmatch?: TestRemoveMatch, ctrl?: Control,
  ): Promise<TestEntity> {
    ...
    try {
      ...
      if (err) {
        ...
        // Off-happy-path (throw disabled): typed as any so the method's
        // Promise<TestEntity> return stays clean under strict null checks.
        return undefined as any
      }
    }
  }
