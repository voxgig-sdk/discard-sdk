...
exports.DiscardEntityBase = void 0;
const node_util_1 = require("node:util");
// TODO: needs Entity superclass
// `D` is the entity's typed data model (e.g. Advice); subclasses bind it via
// `class AdviceEntity extends DiscardEntityBase<Advice>`.
class DiscardEntityBase {
    name = '';
    name_ = '';
    Name = '';
    _client;
...
exports.DiscardEntityBase = DiscardEntityBase;
//# sourceMappingURL=DiscardEntityBase.js.map