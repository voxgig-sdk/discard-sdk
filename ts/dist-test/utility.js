...
function envOverride(m) {
    if ('TRUE' === process.env.DISCARD_TEST_LIVE ||
        'TRUE' === process.env.DISCARD_TEST_OVERRIDE) {
    ...
    m.DISCARD_TEST_EXPLAIN = process.env.DISCARD_TEST_EXPLAIN || m.DISCARD_TEST_EXPLAIN;
    return m;
}
