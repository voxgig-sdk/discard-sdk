...
(0, node_test_1.describe)('TestingDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-testing', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-testing', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.DISCARD_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.DiscardSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['DISCARD_TEST_TESTING_ENTID'];
    ...
    const client = new __1.DiscardSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=TestingDirect.test.js.map