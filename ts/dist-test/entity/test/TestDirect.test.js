...
(0, node_test_1.describe)('TestDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-test', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-test', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['DISCARD_TEST_TEST_ENTID'];
...
//# sourceMappingURL=TestDirect.test.js.map