...
class AiChatEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new AiChatEntity($this->_client, $opts);
    }

    /**
     * @param AiChat|array $args AiChat data (assoc-array) to store.
     */
    ...
    /**
     * @return AiChat|array The current AiChat data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of AiChat fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of AiChat fields).
     */
     ...
     * Create a new AiChat.
     *
     * @param AiChatCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed AiChatCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return AiChat|array The created AiChat as an assoc-array at the
