...
class TestingDirectTest extends TestCase
{
    public function test_direct_load_testing(): void
    {
        $setup = testing_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-testing", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
