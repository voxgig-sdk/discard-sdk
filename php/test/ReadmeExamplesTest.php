...
// Discard SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (DiscardSDK::test)
...
{
    private const SDK_CLASS = 'DiscardSDK';
    ...
    private const SDK_BASE = 'discard_sdk';
