...
class DiscardTestRunner
{
    ...
    {
        $live = self::getenv('DISCARD_TEST_LIVE');
        $override = self::getenv('DISCARD_TEST_OVERRIDE');
        ...
        $explain = self::getenv('DISCARD_TEST_EXPLAIN');
...
class_alias('DiscardTestRunner', 'Runner');
class_alias('DiscardHelpers', 'Helpers');
