...
class TestDirectTest extends TestCase
{
    public function test_direct_load_test(): void
    {
        $setup = test_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-test", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
