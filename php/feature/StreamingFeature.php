...
class DiscardStreamingFeature extends DiscardBaseFeature
{
    ...
    private function _iterate(DiscardResult $result): \Generator
    {
    ...
    private function _streamable(DiscardContext $ctx): bool
    {
