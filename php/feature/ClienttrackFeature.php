...
// Discard SDK clienttrack feature
...
class DiscardClienttrackFeature extends DiscardBaseFeature
{
    ...
    public function PostConstruct(DiscardContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Discard-SDK';
