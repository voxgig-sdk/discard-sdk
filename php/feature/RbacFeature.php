...
class DiscardRbacFeature extends DiscardBaseFeature
{
    ...
    private function _required(DiscardContext $ctx): ?string
    {
    ...
    private function _reject(DiscardContext $ctx, string $required): void
    {
    ...
    private function _track(DiscardContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
