...
class DiscardRatelimitFeature extends DiscardBaseFeature
{
    ...
    private function _acquire(DiscardContext $ctx): void
    {
    ...
    private function _track(DiscardContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
