...
The PHP SDK for the Discard API — an entity-oriented client using PHP conventions.
...
```
php/
├── discard_sdk.php          -- Main SDK class
...
The main class (`discard_sdk.php`) exports the SDK class
