...
The PHP SDK for the Discard API. Provides an entity-oriented interface using PHP conventions.
...
```php
// Create
[$created, $_] = $client->AiChat(null)->create(["name" => "Example"], null);
...
[$result, $err] = $client->Discard(null)->load(
    ["id" => "test01"], null
);
