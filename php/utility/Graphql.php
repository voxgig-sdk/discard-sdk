...
class DiscardGraphql
{
    ...
    // equivalent.
    public static function body(DiscardContext $ctx): mixed
    {
    ...
    public static function errors(DiscardContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
