...
from discard_sdk.utility import register

# Load features
from discard_sdk.feature.base_feature import DiscardBaseFeature
from discard_sdk.features import _has_feature, _make_feature
...
class DiscardSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = DiscardUtility()
        self._utility = utility

        from discard_sdk.config import shared_config
    ...
    def get_utility(self):
        return DiscardUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("DiscardSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Testing(self, data=None) -> "TestingEntity":
        ...
        from discard_sdk.entity.testing_entity import TestingEntity
