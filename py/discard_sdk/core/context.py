...
from discard_sdk.core.helpers import get_ctx_prop, to_map
...
class DiscardContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(rp, DiscardResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return DiscardError(code, msg, self)
