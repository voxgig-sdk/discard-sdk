# Discard SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions DiscardSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both DiscardSDK(...) and DiscardSDK.test(...) become
#      DiscardSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "discard_sdk"
_SDK_CLASS = "DiscardSDK"
