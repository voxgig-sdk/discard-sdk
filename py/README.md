...
The Python SDK for the Discard API. Provides an entity-oriented interface following Pythonic conventions.
...
```python
# Create
created, _ = client.AiChat(None).create({"name": "Example"}, None)
...
result, err = client.Discard(None).load(
    {"id": "test01"}, None
)
