...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/discard` | `npm install @voxgig-sdk/discard` |
| Python | `voxgig-sdk-discard` | `pip install voxgig-sdk-discard` |
| PHP | `voxgig-sdk/discard` | `composer require voxgig-sdk/discard` |
| Golang | `github.com/voxgig-sdk/discard-sdk/go` | `go get github.com/voxgig-sdk/discard-sdk/go` |
| Ruby | `voxgig-sdk-discard` | `gem install voxgig-sdk-discard` |
| Lua | `voxgig-sdk-discard` | `luarocks install voxgig-sdk-discard` |
