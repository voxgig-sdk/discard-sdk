...
func (sdk *DiscardSDK) OptionsMap() map[string]any {
...
func (sdk *DiscardSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *DiscardSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *DiscardSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *DiscardSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *DiscardSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *DiscardSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("DiscardSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *DiscardSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *DiscardSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("DiscardSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
