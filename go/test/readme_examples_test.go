...
const testSeed = `map[string]any{"entity": map[string]any{"ai_chat": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "test": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "testing": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
