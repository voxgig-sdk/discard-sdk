...
func NewTestingEntity(client *core.DiscardSDK, entopts map[string]any) *TestingEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *TestingEntity) GetName() string { return e.name }
...
func (e *TestingEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *TestingEntity) Deleted() bool {
	return e.deleted
}


func (e *TestingEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewTestingEntity(e.client, opts)
}

func (e *TestingEntity) Data(args ...any) any {
...
func (e *TestingEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Testing; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *TestingEntity) DataTyped(data ...Testing) Testing {
	if len(data) > 0 {
		return typedFrom[Testing](e.Data(asMap(data[0])))
	}
	return typedFrom[Testing](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Testing (all fields
// optional at the wire level).
func (e *TestingEntity) MatchTyped(match ...Testing) Testing {
	if len(match) > 0 {
		return typedFrom[Testing](e.Match(asMap(match[0])))
	}
	return typedFrom[Testing](e.Match())
}
...
func (e *TestingEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *TestingEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// TestingLoadMatch and returns an Testing. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *TestingEntity) LoadTyped(reqmatch TestingLoadMatch, ctrl map[string]any) (Testing, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Testing{}, err
	}
	return typedFrom[Testing](res), nil
}



func (e *TestingEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *TestingEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// TestingCreateData and returns an Testing. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *TestingEntity) CreateTyped(reqdata TestingCreateData, ctrl map[string]any) (Testing, error) {
...
func (e *TestingEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *TestingEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *TestingEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
