...
func NewAiChatEntity(client *core.DiscardSDK, entopts map[string]any) *AiChatEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *AiChatEntity) GetName() string { return e.name }
...
func (e *AiChatEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *AiChatEntity) Deleted() bool {
	return e.deleted
}


func (e *AiChatEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewAiChatEntity(e.client, opts)
}

func (e *AiChatEntity) Data(args ...any) any {
...
func (e *AiChatEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *AiChatEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *AiChatEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *AiChatEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
func (e *AiChatEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *AiChatEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *AiChatEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
