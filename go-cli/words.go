...
func registerSDKWords(r *eng.Registry, client *sdk.DiscardSDK) {
...
func runOp(client *sdk.DiscardSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
