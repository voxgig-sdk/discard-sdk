...
class AiChatEntity
  ...
  # @return [AiChat, Hash] the current AiChat data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of AiChat fields)
  def match_get
  ...
  # Create a new AiChat.
  #
  # @param reqdata [AiChatCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [AiChat, Hash] the created AiChat; raises DiscardError on failure
