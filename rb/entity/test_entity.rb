...
class TestEntity
  ...
  # Create a new Test.
  #
  # @param reqdata [TestCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Test, Hash] the created Test; raises DiscardError on failure
  ...
  #
  # @param reqdata [TestUpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Test, Hash] the updated Test; raises DiscardError on failure
