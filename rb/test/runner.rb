...
module DiscardTestRunner
  ...
  def self.env_override(m)
    live = getenv("DISCARD_TEST_LIVE")
    override = getenv("DISCARD_TEST_OVERRIDE")
    ...
    explain = getenv("DISCARD_TEST_EXPLAIN")
    m["DISCARD_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = DiscardTestRunner
Helpers = DiscardHelpers
Vs = VoxgigStruct
