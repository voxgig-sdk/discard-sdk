...
describe("TestingDirect", function()
  it("should direct-load-testing", function()
    local setup = testing_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-testing", setup.live and "live" or "unit")
...
function testing_direct_setup(mockres)
