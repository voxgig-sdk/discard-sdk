...
describe("TestEntity", function()
  ...
  it("should run basic flow", function()
    ...
    assert.is_nil(err)
    test_ref01_data = helpers.to_map(type(test_ref01_data_result) == 'table' and test_ref01_data_result.data_get and test_ref01_data_result:data_get() or test_ref01_data_result)
    ...
    assert.is_nil(err)
    local test_ref01_resdata_up0 = helpers.to_map(type(test_ref01_resdata_up0_result) == 'table' and test_ref01_resdata_up0_result.data_get and test_ref01_resdata_up0_result:data_get() or test_ref01_resdata_up0_result)
    ...
    assert.is_nil(err)
    local test_ref01_data_dt0_load_result = helpers.to_map(type(test_ref01_data_dt0_loaded) == 'table' and test_ref01_data_dt0_loaded.data_get and test_ref01_data_dt0_loaded:data_get() or test_ref01_data_dt0_loaded)
