...
describe("TestDirect", function()
  it("should direct-load-test", function()
    local setup = test_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-test", setup.live and "live" or "unit")
...
function test_direct_setup(mockres)
